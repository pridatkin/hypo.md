...
The main page (/) automatically looks for a file named Home.md in the root of the notes directory. If found, its content is rendered as the home page. If you need the home note to be nested (e.g. notes/Start/Home.md), you can adjust the lookup path in src/routes/home.js.
...
| `HOME_NOTE` | `./notes/Home.md` | Path to the note of main page              |
