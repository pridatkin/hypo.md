...
Named after the idea that notes should be a *hypothesis* — quick to write,
...
- The notes directory is re-scanned on every request. Fine for hundreds of
  files; cache it if you have thousands.
